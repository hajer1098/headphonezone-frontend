...
import { findSumTractionsByDate } from '../fn/statistics/find-sum-tractions-by-date';
import { FindSumTractionsByDate$Params } from '../fn/statistics/find-sum-tractions-by-date';
...
export class StatisticsService extends BaseService {
   ...
   */
  findSumTractionsByDate$Response(params: FindSumTractionsByDate$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<TransactionSumDetails>>> {
    return findSumTractionsByDate(this.http, this.rootUrl, params, context);
  }
   ...
   * This method doesn't expect any request body.
   */
  findSumTractionsByDate(params: FindSumTractionsByDate$Params, context?: HttpContext): Observable<Array<TransactionSumDetails>> {
